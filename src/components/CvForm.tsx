            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  ...
                  placeholder="Ex: Jean"
                  className="w-full text-sm px-3.5 py-2 border border-slate-200 focus:outline-slate-800 rounded-lg text-slate-800"
                />
              </div>
              <div>
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs font-semibold text-slate-700 mb-1">Phrase d'accroche / Résumé de profil (Max 4-5 lignes)</label>
                <textarea 
                  rows={4}
                  value={data.personalInfo.summary}
                  onChange={(e) => updatePersonalInfo('summary', e.target.value)}
                  placeholder="Ex: Développeur passionné avec plus de 5 ans d'expérience..."
                  className="w-full text-sm px-3.5 py-2 border border-slate-200 focus:outline-slate-800 rounded-lg text-slate-800 resize-none leading-relaxed"
                />
              </div>
            </div>
